const IndexPage = () => (
  <div className="bg-background-1 bg-cover bg-no-repeat min-h-screen flex place-items-center w-full lg:items-start lg:bg-background-tab-1">
    <div className="home-content  mt-[10rem] mx-[5rem] flex justify-between w-full lg:text-center lg:flex-col lg:mt-[15rem] ">
      <div className="col ">
        ...
        <div className="footer-txt text-[#D0D6F9] leading-[32px] max-w-[30rem] mx-auto">
          <p>
